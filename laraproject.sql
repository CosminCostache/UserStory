...
(10) unsigned NOT NULL,
  `filename` varchar
(300) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY
(`id`),
  KEY `task_files_task_id_foreign`
(`task_id`),
  CONSTRAINT `task_files_task_id_foreign` FOREIGN KEY
...
id`,`task_id
`,`filename`,`created_at`,`updated_at`) values
...
(1) NOT NULL DEFAULT '0',
  ...
  PRIMARY KEY
(`id`),
  KEY `tasks_project_id_foreign`
(`project_id`),
  KEY `tasks_user_id_foreign`
(`user_id`),
  CONSTRAINT `tasks_project_id_foreign` FOREIGN KEY
(`project_id`) REFERENCES `projects`
(`id`) ON
DELETE CASCADE,
  CONSTRAINT `tasks_user_id_foreign` FOREIGN KEY
(`user_id`) REFERENCES `users`
(`id`) ON
DELETE CASCADE
) ENGINE=InnoDB
AUTO_INCREMENT=162 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `tasks` */

insert  into `tasks`(`
id`,`user_id
`,`project_id`,`task_title`,`task`,`priority`,`completed`,`created_at`,`updated_at`,`duedate`) values
...
insert  into `users`(`
id`,`admin
`,`name`,`email`,`password`,`remember_token`,`created_at`,`updated_at`) values
(1,0,'Not Assigned','not@assigned.com','',NULL,NULL,NULL),
(5,1,'Demo User','user@userStory.com','$2y$10$9PdOI6amvNuEZILOae9/VOg2TkxmNAlBMVOJnG1OuXTqipIJ8dGFq','o316476iw7HA1xU0FfAgudzGdIRSPJPFaf3QSmg0umcDmecbZzhuAJVhp41g','2017-08-29 12:08:01','2019-01-27 11:58:26'),
